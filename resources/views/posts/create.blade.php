        ...
        <div class="flex flex-wrap  justify-center">
            <div class="md:w-full pr-4 pl-4">
                <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300">
                    <div class="py-3 px-6 mb-0 bg-gray-200 border-b-1 border-gray-300 text-gray-900">Post - create</div>
                    <button class="absolute top-1 right-1 py-2 px-4 mb-0 bg-blue-500 hover:bg-blue-700 text-white font-bold rounded cursor-pointer">
                      <a href="{{ route('dashboard') }}">Post - list</a></button>
                    ...
                    <div class="flex-auto p-6">
                        ...
                        {!! Form::submit('Create',['class' => 'bg-blue-500 hover:bg-blue-700 cursor-pointer text-white font-bold py-2 px-4 rounded']) !!}
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
